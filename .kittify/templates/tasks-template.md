...
**Tests**: Per constitution Principle IV (Test-After Validation), each work package MUST include validation criteria. Test tasks scheduled after core implementation; contract and integration tests required for APIs and cross-component interactions.
