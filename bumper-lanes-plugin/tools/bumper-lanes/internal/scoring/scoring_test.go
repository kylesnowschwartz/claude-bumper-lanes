...
func TestCalculate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			stats: &StatsJSON{
				Files:  []FileStatJSON{},
				Totals: TotalsJSON{Adds: 0, Dels: 0, FileCount: 0},
			},
			wantScore: 0,
		},
		{
			...
			stats: &StatsJSON{
				...
				Totals: TotalsJSON{Adds: 100, FileCount: 1},
			},
		...
		},
		{
			...
			stats: &StatsJSON{
				...
				Totals: TotalsJSON{Adds: 100, FileCount: 2},
			},
		...
		},
		{
			...
			stats: &StatsJSON{
				...
				Totals: TotalsJSON{Adds: 60, FileCount: 6},
			},
		...
		},
		{
			...
			stats: &StatsJSON{
				...
				Totals: TotalsJSON{Adds: 55, FileCount: 11},
			},
